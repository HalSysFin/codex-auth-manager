# CAM Cursor Extension First-Time Setup

## Required

Set these two settings in Cursor after installing the VSIX:
...
If you use Cursor over Remote SSH, the extension includes remote host context in the derived machine identity so different remote targets stay separate in Codex Auth Manager.
